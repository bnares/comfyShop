  ...
  return (
    <div className='grid lg:grid-cols-2 gap-24 items-center'>
      <div className=''>
        ...
        <p className='mt-8 max-w-xl text-lg leading-8'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Culpa dolore nemo reprehenderit at placeat esse tempore nam facere dolorum? Cupiditate praesentium amet ab sequi excepturi.</p>
        <div>
